...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-gradient-to-r from-purple-600 to-pink-500 text-white hover:from-purple-700 hover:to-pink-600 focus:ring-purple-500 shadow-lg hover:shadow-xl',
      secondary: 'bg-white text-purple-700 border border-purple-200 hover:bg-purple-50 focus:ring-purple-500',
